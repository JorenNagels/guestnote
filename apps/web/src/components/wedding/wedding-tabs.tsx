 ...
 * wedding without going back to the sidebar. Every slice that owns a wedding screen renders
 * `<WeddingTabs weddingId={id} current="budget" />` under its own heading.
 *
 * ## Links, not ARIA tabs
 *
 ...
 */
export async function WeddingTabs({
  weddingId,
  current,
}: {
  weddingId: string
